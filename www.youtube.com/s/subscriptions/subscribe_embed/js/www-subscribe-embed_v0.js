(function() {
    ...
    r('String.prototype.startsWith', function(a) {
        return a ? a : function(b, c) {
            ...
            for (var e = d.length, f = b.length,
                    g = Math.max(0, Math.min(c | 0, d.length)), h = 0; h < f && g < e;)
                if (d[g++] != b[h++]) return !1;
            return h >= f
        }
    });
    ...
    var Xa = Array.prototype.indexOf ? function(a, b) {
        ...
        Ya = Array.prototype.filter ? function(a, b, c) {
            ...
            for (var d = a.length, e = [], f = 0,
                    g = 'string' === typeof a ? a.split('') : a, h = 0; h < d; h++)
                if (h in g) {
                    var k = g[h];
        ...
        Za = Array.prototype.map ? function(a, b) {
            ...
            for (var c = a.length, d = Array(c),
                    e = 'string' === typeof a ? a.split('') : a, f = 0; f < c; f++)
    ...
    function bb(a, b) {
        ...
        return 0 > c ?
            null : 'string' === typeof a ? a.charAt(c) : a[c]
    }
    ...
    m.clear = function() {
        for (var a = (this.f.cookie || '').split(';'), b = [], c = [], d, e, f = 0; f < a.length; f++)
            e = tb(a[f]), d = e.indexOf('='), -1 == d ? (b.push(''), c.push(e)) :
    ...
    function Ld(a, b, c, d) {
        ...
        return Md(a, function(f) {
            return (!e || f.nodeName == e) &&
                (!c ||
                    'string' === typeof f.className && cb(f.className.split(/\s+/), c))
        }, !0, d)
    }
    ...
    function ee(a) {
        ...
        for (a = a.parentNode; a && a != b; a = a.parentNode)
            if (11 == a.nodeType && a.host && (a = a.host), c = ce(a, 'position'),
                d = d && 'static' == c && a != b.documentElement && a != b.body, !d &&
    ...
    function ke(a) {
        var b = le;
        if ('none' != ce(a, 'display')) return b(a);
        var c = a.style,
            d = c.display,
            e = c.visibility,
            f = c.position;
    ...
    function le(a) {
        ...
        return (void 0 === b || d) && a.getBoundingClientRect ?
            (a = de(a), new gd(a.right - a.left, a.bottom - a.top)) :
            new gd(b, c)
    }
    ...
    function Ie(a) {
        var b = te(String(v.location.href)),
            c;
    ...
    function of (a, b) {
        ...
        if (f['::'] && d.length) {
            for (var g = [], h = null; h = d.shift();) {
                ...
                var l = g.length && g[g.length - 1] || null,
                    n = l;
                l && l.hint == k || (n = {
                    hint: k,
                    features: []
    ...
    function Sf(a, b) {
        if (0 == a.f)
            if (a.i) {
                var c = a.i;
                if (c.g) {
                    for (var d = 0, e = null, f = null, g = c.g; g && (g.g || (d++, g.f == a && (e = g), !(e && 1 < d))); g = g.next)
                        e || (f = g);
                    e &&
                        (0 == c.f && 1 == d ? Sf(c, b) :
    ...
    function Kg(a, b, c, d, e, f, g) {
        ...
        c == g || c && g && c.width == g.width && c.height == g.height ||
            (c = g, g = jd(b), a = pd(hd(g).f), !D || Kc('10') || a && Kc('8') ?
                (b = b.style,
    ...
    function Lg(a, b) {
        var c = !1,
            d = a.subscribe('ROOT_MENU_REMOVED', function(e) {
    ...
    var Vh = v.ytEventsEventsCounter || {
        count: 0
    };
    ...
    function T(a, b, c, d) {
        ...
        if (e) return e;
        e = ++Vh.count + '';
        var f = !('mouseenter' != b && 'mouseleave' != b || !a.addEventListener ||
    ...
    function Yi(a) {
        var b = G('yt-uix-tooltip-shared-mask'),
            c = b && Md(b, function(d) {
                return d == a
            }, !1, 2);
    ...
    function bj(a) {
        var b = cj();
        if (b = window.open(
                b, 'loginPopup', 'width=375,height=440,resizable=yes,scrollbars=yes', !0)) {
    ...
    var ij = ej('initial_gel_batch_timeout', 1E3),
        jj = Math.pow(2, 16) - 1,
        kj = null,
        lj = 0,
        mj = void 0,
    ...
    function Nj(a, b) {
        b = void 0 === b ? {} : b;
        var c = pi(a),
            d = X('web_ajax_ignore_global_headers_if_set'),
            e;
        for (e in Kj) {
            var f = P(Kj[e]);
    ...
    function Yj() {
        for (var a = {}, b = u(Object.entries(mi(P('DEVICE', '')))), c = b.next(); !c.done; c = b.next()) {
            var d = u(c.value);
            c = d.next().value;
            d = d.next().value;
        ...
        al ||
            (al =
                Qf(Tk('YtIdbMeta', 1, {
                    ...
                    function(b) {
                        return Ak(b) ? Tk('YtIdbMeta', void 0, {
                            blocking: a
                        }) : Mf(b)
                    }));
        return al
    ...
    var Al = ej('networkless_throttle_timeout') || 100,
        Bl = ej('networkless_retry_attempts') || 1,
        Cl = 0;
    ...
    function Kl() {
        a: {
            ...
            if (Jl)
                for (a = 1, b = 0; b < Jl.length; b++) d[a % 16] =
                    d[a % 16] ^ d[(a - 1) % 16] / 4 ^ Jl.charCodeAt(b),
                    a++
        }
        a = [];
        ...
        if (a !== P(Ml(c)) || b !== P(Nl(c)))
            if (Ql(a, d, c), eh(Ml(c), a), eh(Nl(c), b),
                ...
                function() {
                    setTimeout(function() {
                        a &&
                            Dj('foregroundHeartbeatScreenAssociated', {
                                clientDocumentNonce: Ll,
                                clientScreenNonce: a
                            }, Il)
                    }, 0)
                },
    ...
    function Vl(a, b, c, d) {
        var e = J(b, U(a, 'group')),
            f = !!a.j(b, 'button-menu-ignore-group');
        e = e && !f ? e : b;
        f = 9;
        var g = 8,
            h = me(b);
    ...
    m.cb = function(a, b, c) {
        ...
        d = J(c, U(this, 'menu'));
        e = d == Tl(this, a);
        var f = M(c, U(this, 'menu-item')),
            g = M(c, U(this, 'menu-close'));
        if (!d || e && (f || g))
            Xl(this, a),
    ...
    function fm(a, b, c) {
        ...
        var f = a.j(b, 'position'),
            g = !!a.j(b, 'force-position'),
    ...
    m.Qa = function(a, b) {
        var c = document.activeElement == b,
            d = km(b),
            e = d.indexOf(a);
    ...
    function km(a) {
        ...
        a = Ya(xd(a), function(b) {
            return 'LI' == b.tagName.toUpperCase()
        });
        return Ya(Za(a, function(b) {
            return Ri(b) ? Bd(b, function(c) {
                return yd(c) ? Gd(c) : !1
            }) : !1
        }), function(b) {
            return !!b
    ...
    m.xa = function(a, b) {
        var c = 'yt-uix' + (this.o ? '-' + this.o : '') + '-card',
            d = null;
    ...
    m.La = function(a) {
        if (Em != a) {
            ...
            var b = y(this.show, this, a),
                c = parseInt(this.j(a, 'delay-show'), 10);
            b = kh(b, -1 < c ? c : 200);
    ...
    function bn(a, b) {
        var c = a.j(b, 'style-type'),
            d = !!a.j(b, 'is-subscribed');
        c = '-' + c;
    ...
    m.pb = function(a) {
        var b = !!this.j(a, 'ypc-item-type'),
            c = !!this.j(a, 'ypc-item-id');
    ...
    function dn(a, b, c) {
        c = void 0 === c ? {} : c;
        var d = Il;
        P('ytLoggingEventsDefaultDisabled', !1) && Il == Il && (d = null);
        Dj(a, b, d, c)
    };
    var en = [{
            Ka: function(a) {
            ...
            if ((window && window.yterr || e) && !(5 <= kn) && 0 !== a.sampleWeight) {
                ...
                if (a.hasOwnProperty('args') && a.args && a.args.length)
                    for (var l = 0, n = 0; n < a.args.length; n++) {
                        ...
                        if (p)
                            if (Array.isArray(p))
                                for (var t = d, w = 0; w < p.length && !(p[w] && (l += pn(w, p[w], q, t), 500 < l)); w++)
                            ;
    ...
    function qn(a, b) {
        for (var c = [], d = 1; d < arguments.length; ++d) c[d - 1] = arguments[d];
        if (!rn(a) || c.some(function(e) {
                return !rn(e)
            }))
            throw Error('Only objects may be merged.');
        c = u(c);
        for (d = c.next(); !d.done; d = c.next()) sn(a, d.value);
        return a
    }
    ...
    pa(Bn, Q);
    var Cn = new R('aft-recorded', An),
        Dn = new R('timing-sent', Bn);
    var En = window;
    ...
    function Nn(a) {
        var b = Jn(a || ''),
            c = In(a);
        c && !Hn && (S(Cn, new An(Math.round(c - b._start), a)), Hn = !0)
    };
    ...
    function Tn(a, b) {
        ...
        a.f || (a.f = Bh(function() {
            var d = hj(),
                e;
            for (e in Qn) Qn[e] && 6E4 < d - Qn[e].time && delete Qn[e];
            a && (a.f = 0)
        }, 5E3));
        return 5 < c.count ?
        ...
        if (!Zn(a)) {
            var b = Jn(a),
                ...
                f = {
                    v: 2,
                    s: e,
                    action: P((a || '') + 'TIMING_ACTION', void 0)
                },
                g = c.srt;
    ...
    m.save = function() {
        dk(this.f, this.dump(), 63072E3)
    };
    m.clear = function() {
        for (var a in mo) delete mo[a]
    };
    m.dump = function() {
        var a = [],
            b;
        for (b in mo) a.push(b + '=' + encodeURIComponent(String(mo[b])));
        return a.join('&')
    };
    ...
    function xo(a, b) {
        if (b.encryptedTokenJarContents &&
            ...
            setTimeout(function() {
                delete a.f[b.encryptedTokenJarContents]
            }, 1E3 * c);
    ...
    function Co(a) {
        if (!Do) {
            ...
            var c = X('web_enable_client_location_service') ? zo() : void 0,
                d = [];
            c && d.push(c);
            Io.f || (Io.f = new Io);
            c = Io.f;
        ...
        a: {
            var f, g;
            if ((null === (f = a.signalServiceEndpoint) || void 0 === f ?
                    0 :
                    f.signal) &&
    ...
    function Ko(a, b) {
        ...
        return Lo()
            .then(function(d) {
                b.na = Object.assign(Object.assign({}, b.na), {
                    headers: d
                });
                d = Object.assign(Object.assign({}, b.na), {
                    body: c
                });
    ...
    var Mo = ['notification/modify_channel_preference'],
        No = ['browse/edit_playlist'],
        Oo = ['subscription/subscribe'],
    ...
    A(Yo, Q);
    var Zo = new R('ypc-core-load', Uo),
        $o = new R('ypc-guide-sync-success', Vo),
    ...
    function mp(a) {
        if (a.length) {
            ...
            Sj('/subscription_ajax?action_create_subscription_to_all=1', {
                ...
                onError: function() {
                    d();
                    S('subscription-batch-subscribe-failure')
                }
            })
        }
    }
    ...
    function op(a) {
        if (a.length) {
            ...
            c.c = b.join(',');
            var d = function() {
                S('subscription-batch-unsubscribe-loaded');
                up(b, Hi)
            };
            Sj('/subscription_ajax?action_remove_subscriptions=1', {
                method: 'POST',
    ...
    z('yt.setConfig', eh);
    z('yt.config.set', eh);
    z('ytbin.www.subscribeembed.init', function() {
        var a = !0;
        ep.push(Kh(Ai, fp), Kh(Fi, ip));
        a ||
            ep.push(
                Kh(Ei, fp), Kh(Ji, ip), Kh(yi, lp), Kh(zi, np), Kh(Mi, pp),
                Kh(ap, rp), Kh(cp, tp), Kh($o, sp));
        a = Zm.C();
        var b = U(a);
        b in ki ||
            (a.register(), hi(a, 'yt-uix-init-' + b, a.init),
                hi(a, 'yt-uix-dispose-' + b, a.dispose), ki[b] = a);
        ko()
    });
}).call(this);