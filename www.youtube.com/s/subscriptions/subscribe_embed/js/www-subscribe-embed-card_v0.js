(function() {
    ...
    var Ka = Array.prototype.indexOf ? function(a, b) {
        ...
        La = Array.prototype.filter ? function(a, b) {
            ...
            for (var c = a.length, d = [], e = 0,
                    f = 'string' === typeof a ? a.split('') : a, g = 0; g < c; g++)
                if (g in f) {
                    var h = f[g];
    ...
    if (B.document && wb) {
        ...
        Gb = void 0;
    var Ib = Gb;
    var Jb = J('iPhone') && !J('iPod') && !J('iPad') || J('iPod'),
        Kb = J('iPad');
    var Lb = {},
        Mb = null;
    var L = window;
    ...
    r.clear = function() {
        for (var a = (this.f.cookie || '').split(';'), b = [], c = [], d, e, f = 0; f < a.length; f++)
            e = Va(a[f]), d = e.indexOf('='), -1 == d ? (b.push(''), c.push(e)) :
    ...
    function yc(a) {
        var b = kc(String(B.location.href)),
            c;
    ...
    function Dd(a, b) {
        if (0 == a.f)
            if (a.i) {
                var c = a.i;
                if (c.g) {
                    for (var d = 0, e = null, f = null, g = c.g; g && (g.i || (d++, g.f == a && (e = g), !(e && 1 < d))); g = g.next)
                        e || (f = g);
                    e &&
                        (0 == c.f && 1 == d ? Dd(c, b) :
    ...
    D('ytEventsEventsCounter', B.ytEventsEventsCounter || {
        count: 0
    });
    ...
    var Ye = Me('initial_gel_batch_timeout', 1E3),
        Ze = Math.pow(2, 16) - 1,
        $e = null,
        af = 0,
        bf = void 0,
    ...
    function Gf(a, b) {
        ...
        var c = T('XSRF_FIELD_NAME', void 0),
            d = b.xa;
    ...
    function Hf(a, b) {
        var c = T('XSRF_FIELD_NAME', void 0),
            d = T('XSRF_TOKEN', void 0),
            e = b.postBody || '',
            f = b.C,
            g = T('XSRF_FIELD_NAME', void 0),
            h;
    ...
    function Of() {
        for (var a = {}, b = u(Object.entries(He(T('DEVICE', '')))), c = b.next(); !c.done; c = b.next()) {
            var d = u(c.value);
            c = d.next().value;
            d = d.next().value;
    ...
    function of () {
        return {
            ...
            innertubeContextClientVersion: T('INNERTUBE_CONTEXT_CLIENT_VERSION', void 0),
        ...
        Lg ||
            (Lg =
                Bd(Dg('YtIdbMeta', 1, {
                    ...
                    function(b) {
                        return lg(b) ? Dg('YtIdbMeta', void 0, {
                            blocking: a
                        }) : zd(b)
                    }));
        return Lg
    ...
    var kh = Me('networkless_throttle_timeout') || 100,
        lh = Me('networkless_retry_attempts') || 1,
        mh = 0;
    ...
    function vh() {
        a: {
            ...
            if (uh)
                for (a = 1, b = 0; b < uh.length; b++) d[a % 16] =
            ...
            if ((window && window.yterr || d) && !(5 <= Lh) && 0 !== a.sampleWeight) {
                ...
                if (a.hasOwnProperty('args') && a.args && a.args.length)
                    for (var k = 0, l = 0; l < a.args.length; l++) {
                        ...
                        if (m)
                            if (Array.isArray(m))
                                for (var q = c, p = 0; p < m.length && !(m[p] && (k += Oh(p, m[p], n, q), 500 < k)); p++)
                            ;
    ...
    v($h, Ch);
    var ai = new Dh('aft-recorded'),
        bi = new Dh('timing-sent');
    var ci = window;
        ...
        if (!xi(a)) {
            var b = hi(a),
                ...
                f = {
                    v: 2,
                    s: e,
                    action: T((a || '') + 'TIMING_ACTION', void 0)
                },
                g = c.srt;
    ...
    function Hi() {
        ...
        if ('none' != (b || (a.currentStyle ? a.currentStyle.display : null) || a.style && a.style.display)) a = ic(a);
        else {
            b = a.style;
            var c = b.display,
                d = b.visibility,
