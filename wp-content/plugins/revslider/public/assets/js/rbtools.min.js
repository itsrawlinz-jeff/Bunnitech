...
! function(t, e) {
    ...
    function Y(t) {
        ...
        for (n = t.length; n--;) t[n] && (t[n]._gsap || (t[n]._gsap = new Rt(t[n], e))) || t.splice(n, 1);
        return t
    }
    ...
    function ya(t, e, r) {
        if (e.parent && qa(e), e._start = aa(r + e._delay), e._end = aa(e._start + (e.totalDuration() / Math.abs(e.timeScale()) || 0)), function _addLinkedListItem(t, e, r, n, i) {
                void 0 === r && (r = "_first"), void 0 === n && (n = "_last");
                var a, s = t[n];
                if (i)
        ...
        if (ra(t)._dp && t._initted && t._time >= t._dur && t._ts) {
            if (t._dur < t.duration())
                for (var i = t; i._dp;) 0 <= i.rawTime() && i.totalTime(i._tTime, !0), i = i._dp;
            t._zTime = -B
        }
        return t
    }
    ...
    function za(t, e, r, n) {
        return qt(t, e), t._initted ? !r && t._pt && (t._dur && !1 !== t.vars.lazy || !t._dur && t.vars.lazy) && c !== Mt.frame ? (ot.push(t), t._lazy = [e, n], 1) : void 0 : 1
    }

    function Ca(t, e, r) {
        var n = t._repeat,
            i = aa(e);
        return t._dur = i, t._tDur = n ? n < 0 ? 1e12 : aa(i * (n + 1) + t._rDelay * n) : i, r || ra(t.parent), t.parent && xa(t), t
    }
    ...
    function Fa(t, e) {
        ...
        return n(e) && (isNaN(e) || e in a) ? "<" === (r = e.charAt(0)) || ">" === r ? ("<" === r ? s._start : s.endTime(0 <= s._repeat)) + (parseFloat(e.substr(1)) || 0) : (r = e.indexOf("=")) < 0 ? (e in a || (a[e] = o), a[e]) : (i = +(e.charAt(r - 1) + e.substr(r + 1)), 1 < r ? Fa(t, e.substr(0, r - 1)) + i : o + i) : null == e ? o : +e
    }
            ...
            function(t, e, r) {
                ...
                if (!c) {
                    if (!(f = "auto" === d.grid ? 0 : (d.grid || [1, z])[1])) {
                        for (h = -z; h < (h = r[f++].getBoundingClientRect().left) && f < p;);
                        f--
                    }
                    for (c = v[p] = [], n = y ? Math.min(f, p) * b - .5 : m % f, i = y ? p * w / f - .5 : m / f | 0, l = z, u = h = 0; u < p; u++) a = u % f - n, s = i - (u / f | 0), c[u] = o = T ? Math.abs("y" === T ? s : a) : X(a * a + s * s), h < o && (h = o), o < l && (l = o);
                    "random" === m && Oa(c), c.max = h - l, c.min = l, c.v = p = (parseFloat(d.amount) || parseFloat(d.each) * (p < f ? p - 1 : T ? "y" === T ? p / f : f : Math.max(f, p / f)) || 0) * ("edges" === m ? -1 : 1), c.b = p < 0 ? g - p : g, c.u = Ia(d.amount || d.each) || 0, _ = _ && p < 0 ? Ft(_) : _
                }
                return p = (c[t] - c.min) / c.max || 0, aa(c.b + (_ ? _(p) : p) * c.v) + c.u
            }
    }
    ...
    function Ra(u, t) {
        var h, l, e = W(u);
        return !e && r(u) && (h = e = u.radius || z, u.values ? (u = yt(u.values), (l = !p(u[0])) && (h *= h)) : u = Qa(u.increment)), Ga(t, e ? o(u) ? function(t) {
            return l = u(t), Math.abs(l - t) <= h ? l : t
        } : function(t) {
            for (var e, r, n = parseFloat(l ? t.x : t), i = parseFloat(l ? t.y : 0), a = z, s = 0, o = u.length; o--;)(e = l ? (e = u[o].x - n) * e + (r = u[o].y - i) * r : Math.abs(u[o] - n)) < a && (a = e, s = o);
            return s = !h || a <= h ? u[s] : t, l || s === t || p(t) ? s : s + Ia(t)
        } : Qa(u))
    }

    function Sa(t, e, r, n) {
        return Ga(W(t) ? !e : !0 === r ? !!(r = 0) : !n, function() {
            return W(t) ? t[~~(Math.random() * t.length)] : (r = r || 1e-5) && (n = r < 1 ? Math.pow(10, (r + "").length - 2) : 1) && ~~(Math.round((t + Math.random() * (e - t)) / r) * r * n) / n
        })
    }
    ...
    function Za(t) {
        for (var e, r, n, i, a = 0, s = ""; ~(e = t.indexOf("random(", a));) n = t.indexOf(")", e), i = "[" === t.charAt(e + 7), r = t.substr(e + 7, n - e - 7).match(i ? it : H), s += t.substr(a, e - a) + Sa(i ? r : +r[0], +r[1], +r[2] || 1e-5), a = n + 1;
    ...
    function ib(t, e, r) {
        var n, i, a, s, o, u, h, l, f, c, d = t ? p(t) ? [t >> 16, t >> 8 & wt, t & wt] : 0 : xt.black;
        if (!d) {
            if ("," === t.substr(-1) && (t = t.substr(0, t.length - 1)), xt[t]) d = xt[t];
            else if ("#" === t.charAt(0)) 4 === t.length && (t = "#" + (n = t.charAt(1)) + n + (i = t.charAt(2)) + i + (a = t.charAt(3)) + a), d = [(t = parseInt(t.substr(1), 16)) >> 16, t >> 8 & wt, t & wt];
            else if ("hsl" === t.substr(0, 3))
                if (d = c = t.match(H), e) {
                    if (~t.indexOf("=")) return d = t.match(J), r && d.length < 4 && (d[3] = 1), d
                } else s = +d[0] % 360 / 360, o = d[1] / 100, n = 2 * (u = d[2] / 100) - (i = u <= .5 ? u * (o + 1) : u + o - u * o), 3 < d.length && (d[3] *= 1), d[0] = hb(s + 1 / 3, n, i), d[1] = hb(s, n, i), d[2] = hb(s - 1 / 3, n, i);
            else d = t.match(H) || xt.transparent;
            d = d.map(Number)
        }
        return e && !c && (n = d[0] / wt, i = d[1] / wt, a = d[2] / wt, u = ((h = Math.max(n, i, a)) + (l = Math.min(n, i, a))) / 2, h === l ? s = o = 0 : (f = h - l, o = .5 < u ? f / (2 - h - l) : f / (h + l), s = h === n ? (i - a) / f + (i < a ? 6 : 0) : h === i ? (a - n) / f + 2 : (n - i) / f + 4, s *= 60), d[0] = ~~(s + .5), d[1] = ~~(100 * o + .5), d[2] = ~~(100 * u + .5)), r && d.length < 4 && (d[3] = 1), d
    }
    ...
    function kb(t, e, r) {
        ...
        if (u = u.map(function(t) {
                return (t = ib(t, e, 1)) && h + (e ? t[0] + "," + t[1] + "%," + t[2] + "%," + t[3] : t.join(",")) + ")"
            }), r && (a = jb(t), (n = r.c).join(o) !== a.c.join(o)))
            for (s = (i = t.replace(kt, "1").split(tt)).length - 1; l < s; l++) o += i[l] + (~n.indexOf(l) ? u.shift() || h + "0,0,0,0)" : (a.length ? a : u.length ? u : r).shift());
        if (!i)
            for (s = (i = t.split(kt)).length - 1; l < s; l++) o += i[l] + u[l];
        return o + i[s]
    }

    function nb(t) {
        var e, r = t.join(" ");
        if (kt.lastIndex = 0, kt.test(r)) return e = Ot.test(r), t[1] = kb(t[1], e), t[0] = kb(t[0], e, jb(t[1])), !0
    }
    ...
    function yb(t, e, r, n) {
        ...
        return _(t, function(t) {
            for (var e in Ct[t] = at[t] = a, Ct[i = t.toLowerCase()] = r, a) Ct[i + ("easeIn" === e ? ".in" : "easeOut" === e ? ".out" : ".inOut")] = Ct[t + "." + e] = a[e]
        }), a
    }
    ...
    function Ab(r, t, e) {
        ...
        var n = 1 <= t ? t : 1,
            ...
            s = "out" === r ? Vk : "in" === r ? function(t) {
                return 1 - Vk(1 - t)
            } : zb(Vk);
        return i = I / i, s.config = function(t, e) {
            return Ab(r, t, e)
        }, s
    }
    ...
    function Bb(e, r) {
        ...
        void 0 === r && (r = 1.70158);
        var t = "out" === e ? bl : "in" === e ? function(t) {
            return 1 - bl(1 - t)
        } : zb(bl);
    ...
    var R, i, a, h, l, f, c, d, m, g, v, y, T, b, w, x, k, P, C, S, A, F, D, U = {
            autoSleep: 120,
            force3D: "auto",
            nullTargetWarn: 1,
            units: {
        ...
        yt = function toArray(t, e) {
            return !n(t) || e || !a && Pt() ? W(t) ? function _flatten(t, e, r) {
                return void 0 === r && (r = []), t.forEach(function(t) {
                    return n(t) && !e || La(t, 1) ? r.push.apply(r, yt(t)) : r.push(t)
                }) || r
            }(t, e) : La(t) ? vt.call(t, 0) : t ? [t] : [] : vt.call(h.querySelectorAll(t), 0)
        },
        ...
        bt = function _callback(t, e, r) {
            var n, i, a = t.vars,
                s = a[e];
            if (s) return n = a[e + "Params"], i = a.callbackScope || t, r && ot.length && da(), n ? s.apply(i, n) : s.call(i)
        },
        wt = 255,
        xt = {
            aqua: [0, wt, wt],
        ...
        Mt = (b = Date.now, w = 500, x = 33, k = b(), P = k, S = C = 1 / 240, T = {
            ...
            wake: function wake() {
                f && (!a && t() && (i = a = window, h = i.document || {}, at.gsap = ne, (i.gsapVersions || (i.gsapVersions = [])).push(ne.version), K(l || i.GreenSockGlobals || !i.gsap && i || {}), y = i.requestAnimationFrame), g && T.sleep(), v = y || function(t) {
    ...
    function _j(e) {
        var t, r, n = b() - P,
            i = !0 === e;
        w < n && (k += n - x), P += n, T.time = (P - k) / 1e3, (0 < (t = T.time - S) || i) && (T.frame++, S += t + (C <= t ? .004 : C - t), r = 1), i || (g = v(_j)), r && A.forEach(function(t) {
            return t(T.time, n, T.frame, e)
        })
    }

    function sl(t) {
        return t < D ? F * t * t : t < .7272727272727273 ? F * Math.pow(t - 1.5 / 2.75, 2) + .75 : t < .9090909090909092 ? F * (t -= 2.25 / 2.75) * t + .9375 : F * Math.pow(t - 2.625 / 2.75, 2) + .984375
    }
    _("Linear,Quad,Cubic,Quart,Quint,Strong", function(t, e) {
        var r = e < 5 ? e + 1 : e;
        yb(t + ",Power" + (r - 1), e ? function(t) {
            return Math.pow(t, r)
        } : function(t) {
            return t
        }, function(t) {
    ...
    }), Ct.Linear.easeNone = Ct.none = Ct.Linear.easeIn, yb("Elastic", Ab("in"), Ab("out"), Ab()), F = 7.5625, D = 1 / 2.75, yb("Bounce", function(t) {
        return 1 - sl(1 - t)
    }, sl), yb("Expo", function(t) {
        return t ? Math.pow(2, 10 * (t - 1)) : 0
    }), yb("Circ", function(t) {
        return -(X(1 - t * t) - 1)
    }), yb("Sine", function(t) {
        return 1 - G(t * V)
    }), yb("Back", Bb("in"), Bb("out"), Bb()), Ct.SteppedEase = Ct.steps = at.SteppedEase = {
    ...
    var zt, Rt = function GSCache(t, e) {
            this.id = j++, (t._gsap = this).target = t, this.harness = e, this.get = e ? e.get : $, this.set = e ? e.getSetter : Gt
        },
        Et = ((zt = Animation.prototype).delay = function delay(t) {
            return t || 0 === t ? (this._delay = t, this) : this._delay
        }, zt.duration = function duration(t) {
            return arguments.length ? Ca(this, t) : this.totalDuration() && this._dur
        }, zt.totalDuration = function totalDuration(t) {
            return arguments.length ? (this._dirty = 0, Ca(this, this._repeat < 0 ? t : (t - this._repeat * this._rDelay) / (this._repeat + 1))) : this._tDur
            ...
            return this._tTime === t && (this._dur || e) && Math.abs(this._zTime) !== B || (this._ts || (this._pTime = t), ea(this, t, e)), this
            ...
            return arguments.length ? (this.parent && this.parent._sort && ya(this.parent, this, t - this._delay), this) : this._start
            ...
            return new Promise(function(e) {
                function Hm() {
                    var t = n.then;
                    n.then = null, o(r) && (r = r(n)) && (r.then || r === n) && (n.then = t), e(r), n.then = t
                }
                var r = o(t) ? t : ga;
                n._initted && 1 === n.totalProgress() && 0 <= n._ts || !n._tTime && n._ts < 0 ? Hm() : n._prom = Hm
            })
    ...
    function Animation(t, e) {
        var r = t.parent || R;
        this.vars = t, this._delay = +t.delay || 0, (this._repeat = t.repeat || 0) && (this._rDelay = t.repeatDelay || 0, this._yoyo = !!t.yoyo || !!t.yoyoEase), this._ts = 1, Ca(this, +t.duration, 1), this.data = t.data, m || Mt.wake(), r && ya(r, this, e || 0 === e ? e : r._time), t.reversed && this.reversed(!0), t.paused && this.paused(!0)
    }
    ha(Et.prototype, {
        _time: 0,
        _start: 0,
    ...
    var Bt = function(i) {
        function Timeline(t, e) {
            var r;
            return void 0 === t && (t = {}), (r = i.call(this, t, e) || this).labels = {}, r.smoothChildTiming = !!t.smoothChildTiming, r.autoRemoveChildren = !!t.autoRemoveChildren, r._sort = s(t.sortChildren), r
        }
        ...
        return t.to = function to(t, e, r, n) {
            ...
            return e.duration = 0, e.parent = this, e.repeatDelay || (e.repeat = 0), e.immediateRender = !!e.immediateRender, new Vt(t, e, Fa(this, r)), this
        }, t.call = function call(t, e, r) {
            return ya(this, Vt.delayedCall(0, t, e), Fa(this, r))
        }, t.staggerTo = function staggerTo(t, e, r, n, i, a, s) {
            return r.duration = e, r.stagger = r.stagger || n, r.onComplete = a, r.onCompleteParams = s, r.parent = this, new Vt(t, r, Fa(this, i)), this
            ...
            var n, i, a, s, o, u, h, l, f, p, c, d, _ = this._time,
                m = this._dirty ? this.totalDuration() : this._tDur,
                g = this._dur,
                v = this !== R && m - B < t && 0 <= t ? m : t < B ? 0 : t,
                y = this._zTime < 0 != t < 0 && (this._initted || !g);
            if (v !== this._tTime || r || y) {
                if (_ !== this._time && g && (v += this._time - _, t += this._time - _), n = v, f = this._start, u = !(l = this._ts), y && (g || (_ = this._zTime), !t && e || (this._zTime = t)), this._repeat && (c = this._yoyo, o = g + this._rDelay, (g < (n = aa(v % o)) || m === v) && (n = g), (s = ~~(v / o)) && s === v / o && (n = g, s--), c && 1 & s && (n = g - n, d = 1), s !== (p = _t(this._tTime, o)) && !this._lock)) {
                    var T = c && 1 & p,
                        b = T === (c && 1 & s);
                    if (s < p && (T = !T), _ = T ? 0 : g, this._lock = 1, this.render(_, e, !g)._lock = 0, !e && this.parent && bt(this, "onRepeat"), this.vars.repeatRefresh && !d && (this.invalidate()._lock = 1), _ !== this._time || u != !this._ts) return this;
                    if (b && (this._lock = 2, _ = T ? g + 1e-4 : -1e-4, this.render(_, !0), this.vars.repeatRefresh && !d && this.invalidate()), this._lock = 0, !this._ts && !u) return this
                }
                if (this._hasPause && !this._forcing && this._lock < 2 && (h = function _findNextPauseTween(t, e, r) {
                    ...
                    }(this, aa(_), aa(n))) && (v -= n - (n = h._start)), this._tTime = v, this._time = n, this._act = !l, this._initted || (this._onUpdate = this.vars.onUpdate, this._initted = 1, this._zTime = t), _ || !n || e || bt(this, "onStart"), _ <= n && 0 <= t)
                    for (i = this._first; i;) {
                ...
                if (h && !e && (this.pause(), h.render(_ <= n ? 0 : -B)._zTime = _ <= n ? 1 : -1, this._ts)) return this._start = f, xa(this), this.render(t, e, r);
            ...
            void 0 === t && (t = !0), void 0 === e && (e = !0), void 0 === r && (r = !0), void 0 === n && (n = -z);
            for (var i = [], a = this._first; a;) a._start >= n && (a instanceof Vt ? e && i.push(a) : (r && i.push(a), t && i.push.apply(i, a.getChildren(!0, e, r)))), a = a._next;
            return i
            ...
            return n.data = "isPause", this._hasPause = 1, ya(this, n, Fa(this, t))
        }, t.removePause = function removePause(t) {
            var e = this._first;
            for (t = Fa(this, t); e;) e._start === t && "isPause" === e.data && qa(e), e = e._next
        }, t.killTweensOf = function killTweensOf(t, e, r) {
            for (var n = this.getTweensOf(t, r), i = n.length; i--;) It !== n[i] && n[i].kill(t, e);
            return this
        }, t.getTweensOf = function getTweensOf(t, e) {
            for (var r, n = [], i = yt(t), a = this._first; a;) a instanceof Vt ? !ba(a._targets, i) || e && !a.isActive("started" === e) || n.push(a) : (r = a.getTweensOf(i, e)).length && n.push.apply(n, r), a = a._next;
            return n
            ...
            var r = this,
                ...
                a = Vt.to(r, ha(e, {
                    ...
                    lazy: !1,
                    time: n,
                    duration: e.duration || Math.abs(n - (i && "time" in i ? i.time : r._time)) / r.timeScale() || B,
                    onStart: function onStart() {
                        r.pause();
                        var t = e.duration || Math.abs(n - r._time) / r.timeScale();
                        a._dur !== t && Ca(a, t).render(a._time, !0, !0), e.onStart && e.onStart.apply(a, e.onStartParams || [])
                    }
                }));
            return a
            ...
            if (s._dirty) {
                for (i = s.parent; o;) e = o._prev, o._dirty && o.totalDuration(), u < (n = o._start) && s._sort && o._ts && !s._lock ? (s._lock = 1, ya(s, o, n - o._delay)._lock = 0) : u = n, n < 0 && o._ts && (a -= n, (!i && !s._dp || i && i.smoothChildTiming) && (s._start += n / s._ts, s._time -= n, s._tTime -= n), s.shiftChildren(-n, !1, -1e20), u = 0), a < (r = xa(o)) && o._ts && (a = r), o = e;
                Ca(s, s === R && s._time > a ? s._time : Math.min(z, a), 1), s._dirty = 0
            }
            return s._tDur
    ...
    function Ib(t, e, i, a, s, u) {
        ...
        if (ht[t] && !1 !== (h = new ht[t]).init(s, h.rawVars ? e[t] : function _processVars(t, e, i, a, s) {
                ...
                return h
            }(e[t], a, s, u, i), i, a, u) && (i._pt = l = new ee(i._pt, s, t, 0, 1, h.render, h, 0, h.priority), i !== d))
    ...
    var It, Lt = function _addPropTween(t, e, r, i, a, s, u, h, l) {
            ...
            var f, p = t[e],
                ...
                d = o(p) ? l ? Zt : Xt : jt;
            if (n(i) && (~i.indexOf("random(") && (i = Za(i)), "=" === i.charAt(1) && (i = parseFloat(c) + parseFloat(i.substr(2)) * ("-" === i.charAt(0) ? -1 : 1) + (Ia(c) || 0))), c !== i) return isNaN(c + i) ? (p || e in t || L(e, i), function _addComplexStringPropTween(t, e, r, n, i, a, s) {
                var o, u, h, l, f, p, c, d, _ = new ee(this._pt, t, e, 0, 1, Ht, null, i),
                    m = 0,
                    g = 0;
                for (_.b = r, _.e = n, r += "", (c = ~(n += "").indexOf("random(")) && (n = Za(n)), a && (a(d = [r, n], t, e), r = d[0], n = d[1]), u = r.match(et) || []; o = et.exec(n);) l = o[0], f = n.substring(m, o.index), h ? h = (h + 1) % 5 : "rgba(" === f.substr(-5) && (h = 1), l !== u[g++] && (p = parseFloat(u[g - 1]) || 0, _._pt = {
                    _next: _._pt,
                    p: f || 1 === g ? f : ",",
                    s: p,
            ...
            }.call(this, t, e, c, i, d, h || U.stringFilter, l)) : (f = new ee(this._pt, t, e, +c || 0, i - (c || 0), "boolean" == typeof p ? Wt : Qt, 0, d), l && (f.fp = l), u && f.modifier(u, this, t), this._pt = f)
        },
        qt = function _initTween(t, e) {
            var r, n, i, a, o, u, h, l, f, p, c, d, _ = t.vars,
                ...
                D = "auto" === t._overwrite,
                z = t.timeline;
            if (!z || O && m || (m = "none"), t._ease = Dt(m, E.ease), t._yEase = k ? Ft(Dt(!0 === k ? m : k, E.ease)) : 0, k && t._yoyo && !t._repeat && (k = t._yEase, t._yEase = t._ease, t._ease = k), !z) {
                if (C && C.render(-1, !0).kill(), g) {
                    if (qa(t._startAt = Vt.set(S, ha({
                            data: "isStart",
                            overwrite: !1,
                            parent: A,
                            immediateRender: !0,
                    ...
                    if (C) M || (t._startAt = 0);
                    else if (e && (v = !1), qa(t._startAt = Vt.set(S, dt(la(_, st), {
                        overwrite: !1,
                        data: "isFromStart",
                        lazy: v && s(y),
                        immediateRender: v,
                ...
                for (r = la(_, st), d = (l = S[t._pt = 0] ? Z(S[0]).harness : 0) && _[l.prop], y = P && s(y) || y && !P, n = 0; n < S.length; n++) {
                    if (h = (o = S[n])._gsap || Y(S)[n]._gsap, t._ptLookup[n] = p = {}, ut[h.id] && da(), c = F === S ? n : F.indexOf(o), l && !1 !== (f = new l).init(o, d || r, t, c, F) && (t._pt = a = new ee(t._pt, o, f.name, 0, 1, f.render, f, 0, f.priority), f._props.forEach(function(t) {
                            p[t] = a
                        }), f.priority && (u = 1)), !l || d)
                        for (i in r) ht[i] && (f = Ib(i, r, t, c, o, F)) ? f.priority && (u = 1) : p[i] = a = Lt.call(t, o, i, "get", r[i], c, F, 0, _.stringFilter);
                    t._op && t._op[n] && t.kill(o, t._op[n]), D && t._pt && (It = t, R.killTweensOf(o, p, "started"), It = 0), t._pt && y && (ut[h.id] = 1)
                }
        ...
        Yt = function _parseFuncOrString(t, e, r, i, a) {
            return o(t) ? t.call(e, r, i, a) : n(t) && ~t.indexOf("random(") ? Za(t) : t
        },
        ...
        Vt = function(P) {
            function Tween(t, e, n) {
                ...
                var a, o, h, l, f, c, d, _, m = (i = P.call(this, function _inheritDefaults(t) {
                        var e = t.parent || R,
                            r = t.keyframes ? ia : ha;
                        if (s(t.inherit))
                ...
                if (i._targets = k.length ? Y(k) : M("GSAP target " + t + " not found. https://greensock.com", !U.nullTargetWarn) || [], i._ptLookup = [], i._overwrite = b, w || T || u(g) || u(v)) {
                    if (e = i.vars, (a = i.timeline = new Bt({
                            data: "nested",
                            defaults: x || {}
                        })).kill(), a.parent = _assertThisInitialized(i), w) ha(a.vars.defaults, {
                        ease: "none"
                        ...
                        for (o = 0; o < l; o++) {
                            ...
                            h.stagger = 0, _ && dt(h, _), e.yoyoEase && !e.repeat && (h.yoyoEase = e.yoyoEase), c = k[o], h.duration = +Yt(g, _assertThisInitialized(i), o, c, k), h.delay = (+Yt(v, _assertThisInitialized(i), o, c, k) || 0) - i._delay, !T && 1 === l && h.delay && (i._delay = v = h.delay, i._start += v, h.delay = 0), a.to(c, h, d(o, c, k))
                        }
                        g = v = 0
                    }
                    g || i.duration(g = a.duration())
                } else i.timeline = 0;
                return !0 === b && (It = _assertThisInitialized(i), R.killTweensOf(k), It = 0), (y || !g && !w && i._start === i.parent._time && s(y) && function _hasNoPausedAncestors(t) {
            ...
            return t.render = function render(t, e, r) {
                ...
                if (d) {
                    if (_ !== this._tTime || !t || r || this._startAt && this._zTime < 0 != t < 0) {
                        if (n = _, l = this.timeline, this._repeat) {
                            if (s = d + this._rDelay, (d < (n = aa(_ % s)) || c === _) && (n = d), (a = ~~(_ / s)) && a === _ / s && (n = d, a--), (u = this._yoyo && 1 & a) && (f = this._yEase, n = d - n), o = _t(this._tTime, s), n === p && !r && this._initted) return this;
                            a !== o && (!this.vars.repeatRefresh || u || this._lock || (this._lock = r = 1, this.render(s * a, !0).invalidate()._lock = 0))
                        }
                        if (!this._initted && za(this, n, r, e)) return this._tTime = 0, this;
                        for (this._tTime = _, this._time = n, !this._act && this._ts && (this._act = 1, this._lazy = 0), this.ratio = h = (f || this._ease)(n / d), this._from && (this.ratio = h = 1 - h), p || !n || e || bt(this, "onStart"), i = this._pt; i;) i.r(h, i.d), i = i._next;
                        l && l.render(t < 0 ? t : !n && u ? -B : l._dur * h, e, r) || this._startAt && (this._zTime = t), this._onUpdate && !e && (t < 0 && this._startAt && this._startAt.render(t, !0, r), bt(this, "onUpdate")), this._repeat && a !== o && this.vars.onRepeat && !e && this.parent && bt(this, "onRepeat"), _ !== this._tDur && _ || this._tTime !== _ || (t < 0 && this._startAt && !this._onUpdate && this._startAt.render(t, !0, r), !t && d || !(t && 0 < this._ts || !_ && this._ts < 0) || qa(this, 1), e || t < 0 && !p || (bt(this, _ === c ? "onComplete" : "onReverseComplete", !0), this._prom && this._prom()))
                    }
                    ...
                    var i, a = t._zTime < 0 ? 0 : 1,
                        ...
                        o = t._rDelay,
                        u = 0;
                    if (o && t._repeat && (u = gt(0, t._tDur, e), _t(u, o) !== _t(t._tTime, o) && (a = 1 - s, t.vars.repeatRefresh && t._initted && t.invalidate())), (t._initted || !za(t, e, n, r)) && (s !== a || n || t._zTime === B || !e && t._zTime)) {
                        for (t._zTime = e || (r ? B : 0), t.ratio = s, t._from && (s = 1 - s), t._time = 0, t._tTime = u, r || bt(t, "onStart"), i = t._pt; i;) i.r(s, i.d), i = i._next;
                        !s && t._startAt && !t._onUpdate && t._start && t._startAt.render(e, !0, n), t._onUpdate && !r && bt(t, "onUpdate"), u && t._repeat && !r && t.parent && bt(t, "onRepeat"), (e >= t._tDur || e < 0) && t.ratio === s && (t.ratio && qa(t, 1), r || (bt(t, t.ratio ? "onComplete" : "onReverseComplete", !0), t._prom && t._prom()))
                    }
                }(this, t, e, r);
                return this
                ...
                return this._pt = this._op = this._startAt = this._onUpdate = this._act = this._lazy = 0, this._ptLookup = [], this.timeline && this.timeline.invalidate(), P.prototype.invalidate.call(this)
            }, t.kill = function kill(t, e) {
                if (void 0 === e && (e = "all"), !(t || e && "all" !== e) && (this._lazy = 0, this.parent)) return cb(this);
                if (this.timeline) return this.timeline.killTweensOf(t, e, It && !0 !== It.vars.overwrite), this;
                ...
                for (r = this._op = this._op || [], "all" !== e && (n(e) && (o = {}, _(e, function(t) {
                        ...
                        var r, n, i, a, s = t[0] ? Z(t[0]).harness : 0,
                            o = s && s.aliases;
                        if (!o) return e;
                        for (n in r = dt({}, e), o)
                            if (n in r)
                    ...
                    if (~f.indexOf(l[h]))
                        for (o in i = p[h], "all" === e ? (r[h] = e, s = i, a = {}) : (a = r[h] = r[h] || {}, s = e), s)(u = i && i[o]) && ("kill" in u.d && !0 !== u.d.kill(o) || pa(this, u, "_pt"), delete i[o]), "all" !== a && (a[o] = 1);
    ...
    var jt = function _setterPlain(t, e, r) {
        ...
        Jt = function _killPropTweensOf(t) {
            for (var e, r, n = this._pt; n;) r = n._next, n.p === t && !n.op || n.op === t ? pa(this, n, "_pt") : n.dep || (e = 1), n = r;
            return !e
        },
        ...
        ee = (PropTween.prototype.modifier = function modifier(t, e, r) {
            this.mSet = this.mSet || this.set, this.set = _b, this.m = t, this.mt = r, this.tween = e
        }, PropTween);

    function PropTween(t, e, r, n, i, a, s, o, u) {
        this.t = e, this.s = n, this.c = i, this.p = r, this.r = a || Qt, this.d = s || this, this.set = o || jt, this.pr = u || 0, (this._next = t) && (t._prev = this)
    }
    ...
    }), at.TweenMax = at.TweenLite = Vt, at.TimelineLite = at.TimelineMax = Bt, R = new Bt({
        sortChildren: !1,
        defaults: E,
    ...
    var re = {
        registerPlugin: function registerPlugin() {
            ...
            e.forEach(function(t) {
                return function _createPlugin(t) {
                    ...
                    if (Pt(), t !== n) {
                        if (ht[e]) return;
                        ha(n, ha(la(t, i), a)), dt(n.prototype, dt(i, la(t, a))), ht[n.prop = e] = n, t.targetTest && (pt.push(n), st[e] = 1), e = ("css" === e ? "CSS" : e.charAt(0).toUpperCase() + e.substr(1)) + "Plugin"
                    }
        ...
        quickSetter: function quickSetter(r, e, n) {
            ...
            var s = ht[e],
                ...
                u = s ? function(t) {
                    var e = new s;
                    d._pt = 0, e.init(r, n ? t + n : t, d, 0, [r]), e.render(1, e), d._pt && $t(1, d)
                } : o.set(r, e);
        ...
        registerEffect: function registerEffect(t) {
            ...
            (e || "").split(",").forEach(function(t) {
                return t && !ht[t] && !at[t] && M(i + " effect requires " + t + " plugin.")
            }), lt[i] = function(t, e) {
        ...
        exportRoot: function exportRoot(t, e) {
            void 0 === t && (t = {});
            var r, n, i = new Bt(t);
            for (i.smoothChildTiming = s(t.smoothChildTiming), R.remove(i), i._dp = 0, i._time = i._tTime = R._time, r = R._first; r;) n = r._next, !e && !r._dur && r instanceof Vt && r.vars.onComplete === r._targets[0] || ya(i, r, r._start - r._delay), r = n;
            return ya(R, i, 0), i
        },
        utils: {
            wrap: function wrap(e, t, r) {
                var n = t - e;
                return W(e) ? Wa(e, wrap(0, e.length), t) : Ga(r, function(t) {
                    return (n + (t - e) % n) % n + e
                })
            },
            wrapYoyo: function wrapYoyo(e, t, r) {
                var n = t - e,
                    i = 2 * n;
                return W(e) ? Wa(e, wrapYoyo(0, e.length - 1), t) : Ga(r, function(t) {
            ...
            init: function init(t, i, e) {
                e._onInit = function(t) {
                    ...
                    if (n(i) && (e = {}, _(i, function(t) {
                        ...
                        for (r in e)
                            for (n = a.length; n--;)(i = (i = t._ptLookup[n][r]) && i.d) && (i._pt && (i = dc(i, r)), i && i.modifier && i.modifier(e[r], t, a[n], r))
                    }(t, i)
                }
            }
        }
    ...
    }, fc("roundProps", Qa), fc("modifiers"), fc("snap", Ra)) || re;
    ...
    function ed(t, e, r) {
        ...
        return n[e] || n.getPropertyValue(e.replace(Re, "-$1").toLowerCase()) || n.getPropertyValue(e) || !r && ed(t, Ne(e) || e, 1) || ""
    }

    function hd() {
        ! function _windowExists() {
            return "undefined" != typeof window
        }() || (ie = window, ae = ie.document, se = ae.documentElement, ue = dd("div") || {
            style: {}
        }, he = dd("div"), Le = Ne(Le), qe = Ne(qe), ue.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0", fe = !!Ne("perspective"), oe = 1)
    }
    ...
    function kd(e) {
        ...
        try {
            ...
            r = function _getBBoxHack(t) {
                var e, r = dd("svg", this.ownerSVGElement && this.ownerSVGElement.getAttribute("xmlns") || "http://www.w3.org/2000/svg"),
                    n = this.parentNode,
                    i = this.nextSibling,
    ...
    function md(t, e) {
        if (e) {
            var r = t.style;
            e in Ae && (e = Le), r.removeProperty ? ("ms" !== e.substr(0, 2) && "webkit" !== e.substr(0, 6) || (e = "-" + e), r.removeProperty(e.replace(Re, "-$1").toLowerCase())) : r.removeAttribute(e)
        }
    }
    ...
    function rd(t, e, r, n) {
        ...
        var s, o, u, h, l, f, p, c, d, _, m, g, v = new ee(this._pt, t.style, e, 0, 1, Ht),
            y = 0,
            T = 0;
        if (v.b = r, v.e = n, r += "", "auto" === (n += "") && (t.style[e] = n, n = ed(t, e) || n, t.style[e] = r), nb(s = [r, n]), n = s[1], u = (r = s[0]).match(tt) || [], (n.match(tt) || []).length) {
            for (; o = tt.exec(n);) p = o[0], d = n.substring(y, o.index), l ? l = (l + 1) % 5 : "rgba(" !== d.substr(-5) && "hsla(" !== d.substr(-5) || (l = 1), p !== (f = u[T++] || "") && (h = parseFloat(f) || 0, m = f.substr((h + "").length), (g = "=" === p.charAt(1) ? +(p.charAt(0) + "1") : 0) && (p = p.substr(2)), c = parseFloat(p), _ = p.substr((c + "").length), y = tt.lastIndex - _.length, _ || (_ = _ || U.units[e] || m, y === n.length && (n += _, v.e += _)), m !== _ && (h = pd(t, e, f, _) || 0), v._pt = {
                _next: v._pt,
                p: d || 1 === T ? d : ",",
                s: h,
                c: g ? g * c : c - h,
    ...
    function td(t) {
        var e = t.split(" "),
            r = e[0],
            n = e[1] || "50%";
        return "top" !== r && "bottom" !== r && "left" !== n && "right" !== n || (t = r, r = n, n = t), e[0] = Ve[r] || r, e[1] = Ve[n] || n, e.join(" ")
    }
    ...
    function ud(t, e) {
        if (e.tween && e.tween._time === e.tween._dur) {
            ...
            if ("all" === o || !0 === o) s.cssText = "", n = 1;
                ...
                for (i = (o = o.split(",")).length; - 1 < --i;) r = o[i], Ae[r] && (n = 1, r = "transformOrigin" === r ? qe : Le), md(a, r);
            n && (md(a, Le), (n = a._gsap) && (n.svg && a.removeAttribute("transform"), Ge(a, 1)))
        }
    }
    ...
    function Ad(t, e) {
        var r, n, i, a, s = t._gsap,
            o = t.style,
            u = zd(t);
        return s.svg && t.getAttribute("transform") ? "1,0,0,1,0,0" === (u = [(i = t.transform.baseVal.consolidate().matrix).a, i.b, i.c, i.d, i.e, i.f]).join(",") ? Xe : u : (u !== Xe || t.offsetParent || t === se || s.svg || (i = o.display, o.display = "block", (r = t.parentNode) && t.offsetParent || (a = 1, n = t.nextSibling, se.appendChild(t)), u = zd(t), i ? o.display = i : md(t, "display"), a && (n ? r.insertBefore(t, n) : r ? r.appendChild(t) : se.removeChild(t))), e && 6 < u.length ? [u[0], u[1], u[4], u[5], u[12], u[13]] : u)
    }
    ...
    function Ld(t, e, r, i, a, s) {
        var o, u, h = 360,
            ...
            p = s ? f * s : f - i,
            c = i + p + "deg";
        return l && ("short" === (o = a.split("_")[1]) && (p %= h) !== p % 180 && (p += p < 0 ? h : -h), "cw" === o && p < 0 ? p = (p + 36e9) % h - ~~(p / h) * h : "ccw" === o && 0 < p && (p = (p - 36e9) % h - ~~(p / h) * h)), t._pt = u = new ee(t._pt, e, r, i, p, Rc), u.e = c, u.u = "deg", t._props.push(r), u
    }
    ...
    var ie, ae, se, oe, ue, he, le, fe, pe = Ct.Power0,
        ce = Ct.Power1,
        de = Ct.Power2,
        _e = Ct.Power3,
        me = Ct.Power4,
        ...
        Ne = function _checkPropPrefix(t, e, r) {
            ...
            for (t = t.charAt(0).toUpperCase() + t.substr(1); i-- && !(Ye[i] + t in n););
        ...
        Je = function _renderCSSTransforms(t, e) {
            ...
            if (v && (l !== He || h !== He)) {
                var b, w = parseFloat(h) * De,
                    x = Math.sin(w),
                    k = Math.cos(w);
                w = parseFloat(l) * De, b = Math.cos(w), a = Ed(g, a, x * b * -v), s = Ed(g, s, -Math.sin(w) * -v), o = Ed(g, o, k * b * -v + v)
            }
            _ !== $e && (y += "perspective(" + _ + Ke), (n || i) && (y += "translate(" + n + "%, " + i + "%) "), !T && a === $e && s === $e && o === $e || (y += o !== $e || T ? "translate3d(" + a + ", " + s + ", " + o + ") " : "translate(" + a + ", " + s + Ke), u !== He && (y += "rotate(" + u + Ke), h !== He && (y += "rotateY(" + h + Ke), l !== He && (y += "rotateX(" + l + Ke), f === He && p === He || (y += "skew(" + f + ", " + p + Ke), 1 === c && 1 === d || (y += "scale(" + c + ", " + d + Ke), g.style[Le] = y || "translate(0, 0)"
        },
    ...
    var er, rr, nr, ir = {
        ...
        init: function init(t, e, r, n, i) {
            var a, s, o, u, h, l, f, p, c, d, _, m, g, v, y, T = this._props,
                b = t.style;
            for (f in oe || hd(), e)
                if ("autoRound" !== f && (s = e[f], !ht[f] || !Ib(f, e, r, n, t, i)))
                    if (h = typeof s, l = je[f], "function" === h && (h = typeof(s = s.call(r, n, t, i))), "string" === h && ~s.indexOf("random(") && (s = Za(s)), l) l(this, t, f, s, r) && (y = 1);
                    else if ("--" === f.substr(0, 2)) this.add(b, "setProperty", getComputedStyle(t).getPropertyValue(f) + "", s + "", n, i, 0, 0, f);
            else {
                if (a = qd(t, f), u = parseFloat(a), (d = "string" === h && "=" === s.charAt(1) ? +(s.charAt(0) + "1") : 0) && (s = s.substr(2)), o = parseFloat(s), f in Ie && ("autoAlpha" === f && (1 === u && "hidden" === qd(t, "visibility") && o && (u = 0), nd(this, b, "visibility", u ? "inherit" : "hidden", o ? "inherit" : "hidden", !o)), "scale" !== f && "transform" !== f && ~(f = Ie[f]).indexOf(",") && (f = f.split(",")[0])), _ = f in Ae)
                    if (m || ((g = t._gsap).renderTransform || Ge(t), v = !1 !== e.smoothOrigin && g.smooth, (m = this._pt = new ee(this._pt, b, Le, 0, 1, g.renderTransform, g, 0, -1)).dep = 1), "scale" === f) this._pt = new ee(this._pt, g, "scaleY", g.scaleY, d ? d * o : o - g.scaleY), T.push("scaleY", f), f += "X";
                    else {
                        if ("transformOrigin" === f) {
                            s = td(s), g.svg ? Bd(t, s, 0, v, 0, this) : ((c = parseFloat(s.split(" ")[2])) !== g.zOrigin && nd(this, g, "zOrigin", g.zOrigin, c), nd(this, b, f, Qe(a), Qe(s)));
                            continue
                        }
                        if ("svgOrigin" === f) {
                            Bd(t, s, 1, v, 0, this);
                ...
                if (_ || (o || 0 === o) && (u || 0 === u) && !Be.test(s) && f in b)(p = (a + "").substr((u + "").length)) !== (c = (s + "").substr((o + "").length) || (f in U.units ? U.units[f] : p)) && (u = pd(t, f, a, c)), this._pt = new ee(this._pt, _ ? g : b, f, u, d ? d * o : o - u, "px" !== c || !1 === e.autoRound || _ ? Qc : Tc), this._pt.u = c || 0, p !== c && (this._pt.b = a, this._pt.r = Sc);
        ...
        getSetter: function getSetter(t, e, r) {
            var n = Ie[e];
            return n && n.indexOf(",") < 0 && (e = n), e in Ae && e !== qe && (t._gsap.x || qd(t, "x")) ? r && le === r ? "scale" === e ? Zc : Yc : (le = r || {}) && ("scale" === e ? $c : _c) : t.style && !q(t.style[e]) ? Wc : ~e.indexOf("-") ? Xc : Gt(t, e)
        }
    };
    ne.utils.checkPrefix = Ne, nr = _((er = "x,y,z,scale,scaleX,scaleY,xPercent,yPercent") + "," + (rr = "rotation,rotationX,rotationY,skewX,skewY") + ",transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective", function(t) {
        Ae[t] = 1
    }), _(rr, function(t) {
        U.units[t] = "deg", Ze[t] = 1
    }), Ie[nr[13]] = er + "," + rr, _("0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY", function(t) {
        var e = t.split(":");
        Ie[e[1]] = nr[e[0]]
...
! function(e, n) {
    ...
    g() && n.registerPlugin(o), o.version = "3.2.0", e.CustomBounce = o, e.default = o;
    if (typeof(window) === "undefined" || window !== e) {
        Object.defineProperty(e, "__esModule", {
            value: !0
        })
...
! function(e, t) {
    ...
    function arcToSegment(e, t, n, s, a, r, i, o, h) {
        if (e !== o || t !== h) {
            ...
            var L, O = Math.ceil(F(G) / (g / 4)),
                ...
                Z = c * -s,
                U = f * s;
            for (L = 0; L < O; L++) d = B(a = R + L * z), p = k(a), T = B(a += z), V = k(a), j.push(d - I * p, p + I * d, T + I * V, V - I * T, T, V);
            for (L = 0; L < j.length; L += 2) d = j[L], p = j[L + 1], j[L] = d * H + p * Z + N, j[L + 1] = d * Q + p * U + D;
    ...
    function stringToRawPath(e) {
        ...
        var t, n, s, a, r, i, o, h, u, f, c, l, g, m, x, d = (e + "").replace(w, function(e) {
                var t = +e;
        ...
        for (t = 0; t < v; t++)
            if (g = r, isNaN(d[t]) ? i = (r = d[t].toUpperCase()) !== d[t] : t--, s = +d[t + 1], a = +d[t + 2], i && (s += y, a += M), t || (h = s, u = a), "M" === r) o && (o.length < 8 ? --p.length : C += o.length), y = h = s, M = u = a, o = [s, a], p.push(o), t += 2, r = "L";
            else if ("C" === r) i || (y = M = 0), (o = o || [0, 0]).push(s, a, y + 1 * d[t + 3], M + 1 * d[t + 4], y += 1 * d[t + 5], M += 1 * d[t + 6]), t += 6;
        else if ("S" === r) f = y, c = M, "C" !== g && "S" !== g || (f += y - o[o.length - 4], c += M - o[o.length - 3]), i || (y = M = 0), o.push(f, c, s, a, y += 1 * d[t + 3], M += 1 * d[t + 4]), t += 4;
        else if ("Q" === r) f = y + 2 / 3 * (s - y), c = M + 2 / 3 * (a - M), i || (y = M = 0), y += 1 * d[t + 3], M += 1 * d[t + 4], o.push(f, c, y + 2 / 3 * (s - y), M + 2 / 3 * (a - M), y, M), t += 4;
            ...
            if (m = d[t + 4], x = d[t + 5], f = d[t + 6], c = d[t + 7], n = 7, 1 < m.length && (m.length < 3 ? (c = f, f = x, n--) : (c = x, f = m.substr(2), n -= 2), x = m.charAt(1), m = m.charAt(0)), l = arcToSegment(y, M, +d[t + 1], +d[t + 2], +d[t + 3], +m, +x, (i ? y : 0) + 1 * f, (i ? M : 0) + 1 * c), t += n, l)
    ...
    var M, a, t, y = /[-+=\.]*\d+[\.e\-\+]*\d*[e\-\+]*\d*/gi,
        ...
        n = ((t = CustomEase.prototype).setData = function setData(e, t) {
            ...
            for (0 == +c[0] && 1 == +c[n - 2] || function _normalize(e, t, n) {
                ...
                x: +c[r + 4],
                y: +c[r + 5]
            }, g.push(s, a), x(s.x, s.y, +c[r], +c[r + 1], +c[r + 2], +c[r + 3], a.x, a.y, 1 / (2e5 * d), g, g.length - 1);
            ...
            if (i = 1 / (n = 1 / l + 1 | 0), h = g[o = 0], p) {
                for (r = 0; r < n; r++) f = r * i, h.nx < f && (h = g[++o]), s = h.y + (f - h.x) / h.cx * h.cy, m[r] = {
                    x: f,
                    cx: i,
                    y: s,
                    cy: 0,
    ...
    p() && M.registerPlugin(n), n.version = "3.2.0", e.CustomEase = n, e.default = n;
    if (typeof(window) === "undefined" || window !== e) {
        Object.defineProperty(e, "__esModule", {
            value: !0
        })
...
! function(e, t) {
    ...
    g() && n.registerPlugin(t), t.version = "3.2.0", e.CustomWiggle = t, e.default = t;
    if (typeof(window) === "undefined" || window !== e) {
        Object.defineProperty(e, "__esModule", {
            value: !0
        })
...
! function(t, e) {
    ...
    function convertToPath(t, e) {
        var n, r, a, o, i, s, l, h, u, f, g, c, p, d, m, v, x, P, y, w, b, M, R = t.tagName.toLowerCase(),
            T = .552284749831;
    ...
    function getRotationAtBezierT(t, e, n) {
        var r, a = t[e],
            o = t[e + 2],
            i = t[e + 4];
        return a += (o - a) * n, a += ((o += (i - o) * n) - a) * n, r = o + (i + (t[e + 6] - i) * n - o) * n - a, a = t[e + 1], a += ((o = t[e + 3]) - a) * n, a += ((o += ((i = t[e + 5]) - o) * n) - a) * n, O(S(o + (i + (t[e + 7] - i) * n - o) * n - a, r) * s)
    }
    ...
    function sliceRawPath(t, e, n) {
        ...
        var i, s, l, h, u, f, g, c = function copyRawPath(t) {
            ...
            L = R && b < M || T && d.t > m.t;
        if (p || a) {
            if (x(c, w, M, d.t) && (i = 1, w++, T ? L ? m.t /= d.t : (m.t = (m.t - d.t) / (1 - d.t), y++, b = 0) : w <= y + 1 && !L && (y++, R && (b -= M))), m.t ? x(c, y, b, m.t) && (L && i && w++, r && y++) : (y--, r && w--), h = [], f = 1 + (u = c.length) * a, g = w, r)
                for (f += (u - (y = (y || u) - 1) + w) % u, l = 0; l < f; l++) A(h, c[g]), g = (g || u) - 1;
            else
                for (f += (u - w + y) % u, l = 0; l < f; l++) A(h, c[g++ % u]);
            c = h
        } else if (s = 1 === m.t ? 6 : subdivideSegment(v, b, m.t), e !== n)
            for (i = subdivideSegment(P, M, T ? d.t / m.t : d.t), R && (s += i), v.splice(b + s + 2), i && P.splice(0, M + i), l = c.length; l--;)(l < w || y < l) && c.splice(l, 1);
        ...
        }(c, p || a), c.totalLength = 0, c
    }

    function measureSegment(t, e, n) {
        e = e || 0, t.samples || (t.samples = [], t.lookup = []);
        var r, a, o, i, s, l, h, u, f, g, c, p, d, m, v, x, P, y = ~~t.resolution || 12,
            w = 1 / y,
        ...
        for (L.length = S.length = 0, a = e + 2; a < b; a += 6) {
            if (o = t[a + 4] - M, i = t[a + 2] - M, s = t[a] - M, u = t[a + 5] - R, f = t[a + 3] - R, g = t[a + 1] - R, l = h = c = p = 0, Z(o) < 1e-5 && Z(u) < 1e-5 && Z(s) + Z(g) < 1e-5) 8 < t.length && (t.splice(a, 6), a -= 6, b -= 6);
            else
                for (r = 1; r <= y; r++) l = h - (h = ((m = w * r) * m * o + 3 * (d = 1 - m) * (m * i + d * s)) * m), c = p - (p = (m * m * u + 3 * d * (m * f + d * g)) * m), (x = Q(c * c + l * l)) < _ && (_ = x), A += x, L[T++] = A;
            M += o, R += u
        }
        if (N)
            for (N -= A; T < L.length; T++) L[T] += N;
        if (L.length && _)
            for (t.totalLength = P = L[L.length - 1] || 0, t.minLength = _, x = v = 0, r = 0; r < P; r += _) S[x++] = L[v] < r ? ++v : v;
    ...
    function subdivideSegment(t, e, n) {
        ...
        var r = t[e],
            ...
            d = s + (t[e + 6] - s) * n,
            m = l + (t[e + 7] - l) * n;
        return u += (d - u) * n, g += (m - g) * n, t.splice(e + 2, 4, O(h), O(f), O(c), O(p), O(c + (u - c) * n), O(p + (g - p) * n), O(u), O(g), O(d), O(m)), t.samples && t.samples.splice(e / 6 * t.resolution | 0, 0, 0, 0, 0, 0, 0, 0), 6
    }
    ...
    function getProgressData(t, e, n) {
        ...
        var r, a, o, i, s, l, h = 0,
            u = t[0];
        if (1 < t.length) {
            for (o = t.totalLength * e, s = l = 0;
                (s += t[l++].totalLength) < o;) h = l;
            e = (o - (i = s - (u = t[h]).totalLength)) / (s - i) || 0
        }
        return r = u.samples, a = u.resolution, o = u.totalLength * e, i = (l = u.lookup[~~(o / u.minLength)] || 0) ? r[l - 1] : 0, (s = r[l]) < o && (i = s, s = r[++l]), n.path = t, n.segment = u, n.segIndex = h, n.i = 6 * ~~(l / a), n.t = 1 / a * ((o - i) / (s - i) + l % a), n
    }
    ...
    function arcToSegment(t, e, n, r, a, o, i, s, l) {
        if (t !== s || e !== l) {
            ...
            var R = (o === i ? -1 : 1) * Q(M),
                ...
                V = (N * O - A * C < 0 ? -1 : 1) * Math.acos((N * C + A * O) / Q(B * (C * C + O * O)));
            isNaN(V) && (V = g), !i && 0 < V ? V -= c : i && V < 0 && (V += c), D %= c, V %= c;
            var z, E = Math.ceil(Z(V) / (c / 4)),
                X = [],
                k = V / E,
                G = 4 / 3 * U(k / 2) / (1 + H(k / 2)),
                I = u * n,
                ...
                Y = f * -r,
                q = u * r;
            for (z = 0; z < E; z++) m = H(a = D + z * k), v = U(a), N = H(a += k), A = U(a), X.push(m - G * v, v + G * m, N + G * A, A - G * N, N, A);
            for (z = 0; z < X.length; z += 2) m = X[z], v = X[z + 1], X[z] = m * I + v * Y + S, X[z + 1] = m * j + v * q + _;
    ...
    function stringToRawPath(t) {
        ...
        var e, n, r, a, o, i, s, l, h, u, f, g, c, p, d, m = (t + "").replace(R, function(t) {
                var e = +t;
        ...
        for (e = 0; e < y; e++)
            if (c = o, isNaN(m[e]) ? i = (o = m[e].toUpperCase()) !== m[e] : e--, r = +m[e + 1], a = +m[e + 2], i && (r += x, a += P), e || (l = r, h = a), "M" === o) s && (s.length < 8 ? --v.length : w += s.length), x = l = r, P = h = a, s = [r, a], v.push(s), e += 2, o = "L";
            else if ("C" === o) i || (x = P = 0), (s = s || [0, 0]).push(r, a, x + 1 * m[e + 3], P + 1 * m[e + 4], x += 1 * m[e + 5], P += 1 * m[e + 6]), e += 6;
        else if ("S" === o) u = x, f = P, "C" !== c && "S" !== c || (u += x - s[s.length - 4], f += P - s[s.length - 3]), i || (x = P = 0), s.push(u, f, r, a, x += 1 * m[e + 3], P += 1 * m[e + 4]), e += 4;
        else if ("Q" === o) u = x + 2 / 3 * (r - x), f = P + 2 / 3 * (a - P), i || (x = P = 0), x += 1 * m[e + 3], P += 1 * m[e + 4], s.push(u, f, x + 2 / 3 * (r - x), P + 2 / 3 * (a - P), x, P), e += 4;
        else if ("T" === o) u = x - s[s.length - 4], f = P - s[s.length - 3], s.push(x + u, P + f, r + 2 / 3 * (x + 1.5 * u - r), a + 2 / 3 * (P + 1.5 * f - a), x = r, P = a), e += 2;
        else if ("H" === o) nf(x, P, x = r, P), e += 1;
        else if ("V" === o) nf(x, P, x, P = r + (i ? P - x : 0)), e += 1;
        else if ("L" === o || "Z" === o) "Z" === o && (r = l, a = h, s.closed = !0), ("L" === o || .5 < Z(x - r) || .5 < Z(P - a)) && (nf(x, P, r, a), "L" === o && (e += 2)), x = r, P = a;
        else if ("A" === o) {
            if (p = m[e + 4], d = m[e + 5], u = m[e + 6], f = m[e + 7], n = 7, 1 < p.length && (p.length < 3 ? (f = u, u = d, n--) : (f = d, u = p.substr(2), n -= 2), d = p.charAt(1), p = p.charAt(0)), g = arcToSegment(x, P, +m[e + 1], +m[e + 2], +m[e + 3], +p, +d, (i ? x : 0) + 1 * u, (i ? P : 0) + 1 * f), e += n, g)
    ...
    function pointsToSegment(t, e, n) {
        var r, a, o, i, s, l, h, u, f, g, c, p, d, m, v = t.length - 2,
            ...
            M = y - x,
            R = w - P;
        for (isNaN(n) && (n = Math.PI / 10), e = e || 0 === e ? +e : 1, s = 2; s < v; s += 2) r = x, a = P, x = y, P = w, p = (l = M) * l + (u = R) * u, d = (M = (y = +t[s + 2]) - x) * M + (R = (w = +t[s + 3]) - P) * R, m = (h = y - r) * h + (f = w - a) * f, c = (o = Math.acos((p + d - m) / Q(4 * p * d))) / Math.PI * e, g = Q(p) * c, c *= Q(d), x === r && P === a || (n < o ? (i = S(f, h), b.push(O(x - H(i) * g), O(P - U(i) * g), O(x), O(P), O(x + H(i) * c), O(P + U(i) * c))) : (i = S(u, l), b.push(O(x - H(i) * g), O(P - U(i) * g)), i = S(R, M), b.push(O(x), O(P), O(x + H(i) * c), O(P + U(i) * c))));
    ...
    function rawPathToString(t) {
        ...
        var e, n, r, a, o = "",
            i = t.length;
        for (n = 0; n < i; n++) {
            for (a = t[n], o += "M" + O(a[0]) + "," + O(a[1]) + " C", e = a.length, r = 2; r < e; r++) o += O(a[r++]) + "," + O(a[r++]) + " " + O(a[r++]) + "," + O(a[r++]) + " " + O(a[r++]) + "," + O(a[r]) + " ";
            a.closed && (o += "z")
        }
        return o
    }
    ...
    function V(t, e) {
        if (t.parentNode && (f || function _setDoc(t) {
                var e = t.ownerDocument || t;
                !(b in t.style) && "msTransform" in t.style && (z = (b = "msTransform") + "Origin");
            ...
            var n = T(t),
                ...
                l = f.createElementNS ? f.createElementNS(r.replace(/^https/, "http"), a) : f.createElement(a);
            return e && (n ? (P = P || V(t), l.setAttribute("width", 1), l.setAttribute("height", 1), l.setAttribute("transform", "translate(" + o + "," + i + ")"), P.appendChild(l)) : (v || ((v = V(t)).style.cssText = s), l.style.cssText = s + "width:1px;height:1px;top:" + i + "px;left:" + o + "px", v.appendChild(l))), l
        }
    ...
    var f, g, c, m, v, P, y, w, n, b = "transform",
        z = b + "Origin",
        E = [],
        k = [],
        G = ((n = Matrix2D.prototype).inverse = function inverse() {
            var t = this.a,
                ...
                o = this.f,
                i = t * r - e * n;
            return X(this, r / i, -e / i, -n / i, t / i, (n * o - r * a) / i, -(t * o - e * a) / i)
            ...
            var e = this.a,
                ...
                f = t.e,
                g = t.f;
            return X(this, s * e + h * r, s * n + h * a, l * e + u * r, l * n + u * a, o + f * e + g * r, i + f * n + g * a)
    ...
    function Matrix2D(t, e, n, r, a, o) {
        void 0 === t && (t = 1), void 0 === e && (e = 0), void 0 === n && (n = 0), void 0 === r && (r = 1), void 0 === a && (a = 0), void 0 === o && (o = 0), X(this, t, e, n, r, a, o)
    }
        ...
        var r = T(t) ? E : k,
            a = function _placeSiblings(t, e) {
                var n, r, a, o, i, s = T(t),
                    ...
                    h = s ? E : k;
                if (t === g) return t;
                if (h.length || h.push(V(t, 1), V(t, 2), V(t, 3)), n = s ? P : v, s) a = l ? {
                    x: 0,
                    y: 0
                } : t.getBBox(), i = (r = t.transform ? t.transform.baseVal : {}).numberOfItems ? (o = (r = r.consolidate().matrix).a * a.x + r.c * a.y, r.b * a.x + r.d * a.y) : (r = y, o = a.x, a.y), e && "g" === t.tagName.toLowerCase() && (o = i = 0), n.setAttribute("transform", "matrix(" + r.a + "," + r.b + "," + r.c + "," + r.d + "," + (r.e + o) + "," + (r.f + i) + ")"), (l ? s : t.parentNode).appendChild(n);
                else {
                    if (o = i = 0, w)
                        for (r = t.offsetParent, a = t; a && (a = a.parentNode) !== r;) 4 < (g.getComputedStyle(a)[b] + "").length && (o = a.offsetLeft, i = a.offsetTop, a = 0);
                    (a = n.style).top = t.offsetTop - i + "px", a.left = t.offsetLeft - o + "px", r = g.getComputedStyle(t), a[b] = r[b], a[z] = r[z], a.position = "fixed" === r.position ? "fixed" : "absolute", t.parentNode.appendChild(n)
                }
                return n
            }(t, n),
            ...
            u = new G((i.left - o.left) / 100, (i.top - o.top) / 100, (s.left - o.left) / 100, (s.top - o.top) / 100, o.left + (h ? 0 : function _getDocScrollLeft() {
                return g.pageXOffset || f.scrollLeft || c.scrollLeft || m.scrollLeft || 0
            }()), o.top + (h ? 0 : function _getDocScrollTop() {
                return g.pageYOffset || f.scrollTop || c.scrollTop || m.scrollTop || 0
            }()));
    ...
    function ia(t, e, n, r, a, o, i) {
        return e = "cubic" === i.type ? [e] : (e.unshift(ga(n, r, i.unitX), a ? ga(n, a, i.unitY) : 0), i.relative && ha(e), [(a ? pointsToSegment : flatPointsToSegment)(e, i.curviness)]), e = o(K(e, n, i)), tt(t, n, r, e, "x", i.unitX), a && tt(t, n, a, e, "y", i.unitY), cacheRawPathMeasurements(e, i.resolution || (0 === i.curviness ? 20 : 12))
    }
    ...
    function la(t, e, n) {
        ...
        return n.apply(e && "auto" !== e ? r.apply({
    ...
    function ma(t, e, n, r) {
        var a, o = getGlobalMatrix(t.parentNode, !0, !0),
            ...
            h = l.x,
            u = l.y;
        return i.e = i.f = 0, "auto" === r && e.getTotalLength && "path" === e.tagName.toLowerCase() && (a = e.getAttribute("d").match(J) || [], h += (a = i.apply({
            x: +a[0],
            y: +a[1]
        })).x, u += a.y), (a || e.getBBox && t.getBBox) && (h -= (a = i.apply(e.getBBox())).x, u -= a.y), i.e = h - s.x, i.f = u - s.y, i
    }
    var I, j, Y, q, W = ["x", "translateX", "left", "marginLeft"],
        $ = ["y", "translateY", "top", "marginTop"],
        o = Math.PI / 180,
        J = /[-+\.]*\d+[\.e\-\+]*\d*[e\-\+]*\d*/g,
        K = function _align(t, e, n) {
            var r, a, o, i, s = n.align,
                l = n.matrix,
                h = n.offsetX,
                u = n.offsetY,
                f = n.alignOrigin,
                g = t[0][0],
                c = t[0][1];
            return t && t.length ? (s && ("self" === s || (a = q(s)[0] || e) === e ? transformRawPath(t, 1, 0, 0, 1, ga(e, "x") - g, ga(e, "y") - c) : (f && !1 !== f[2] && I.set(e, {
                ...
                skewX: 0,
                skewY: 0
            }).progress(1), o = ma(e, a, f, "auto"), r.render(-1).kill(), i = o.apply({
                x: g,
                y: c
            }), transformRawPath(t, o.a, o.b, o.c, o.d, o.e - (i.x - o.e), o.f - (i.y - o.f)))), l ? transformRawPath(t, l.a, l.b, l.c, l.d, l.e, l.f) : (h || u) && transformRawPath(t, 1, 0, 0, 1, h || 0, u || 0), t) : getRawPath("M0,0L0,0")
        },
        tt = function _addDimensionalPropTween(t, e, n, r, a, o) {
            ...
            u.u = Y(i.get(e, h, o)) || 0, u.path = r, u.pp = a, t._props.push(h)
        },
        a = {
            version: "3.2.0",
            name: "motionPath",
            ...
            init: function init(t, e) {
                if (!I) return console.warn("Please gsap.registerPlugin(MotionPathPlugin)"), !1;
                ...
                if (this.rawPaths = i, this.target = t, (this.rotate = h || 0 === h) && (this.rOffset = parseFloat(h) || 0, this.radians = !!e.useRadians, this.rProp = e.rotation || "rotation", this.rSet = t._gsap.set(t, this.rProp, this), this.ru = Y(t._gsap.get(t, this.rProp)) || 0), !Array.isArray(s) || "closed" in s || "number" == typeof l) cacheRawPathMeasurements(n = u(K(getRawPath(e.path), t, e)), e.resolution), i.push(n), tt(this, t, e.x || "x", n, "x", e.unitX || "px"), tt(this, t, e.y || "y", n, "y", e.unitY || "px");
                else {
                    for (r in l) ~W.indexOf(r) ? a = r : ~$.indexOf(r) && (o = r);
                    for (r in a && o ? i.push(ia(this, fa(fa([], s, a, 0), s, o, 1), t, e.x || a, e.y || o, u, e)) : a = o = 0, l) r !== a && r !== o && i.push(ia(this, fa([], s, r, 0), t, r, 0, u, e))
                }
            },
    ...
    }() || I.registerPlugin(a), t.MotionPathPlugin = a, t.default = a;
