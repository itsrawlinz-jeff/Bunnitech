...
! function(e, t) {
    ...
    window.RSANYID = window.RSANYID === t ? [] : window.RSANYID, window.RSANYID_sliderID = window.RSANYID_sliderID === t ? [] : window.RSANYID_sliderID, e.fn.extend({
        ...
        enterInViewPort: function(a) {
            i[a].waitForCountDown && (P(a), i[a].waitForCountDown = !1), i[a].waitForFirstSlide && (z(a), i[a].waitForFirstSlide = !1, setTimeout(function() {
            ...
            if (i[r] !== t) {
                ...
                if (i[r].forceOverflow && i[r].topc[0].classList.add("rs-forceoverflow"), "carousel" === i[r].sliderType && !0 !== i[r].overflowHidden && i[r].c.css({
                    ...
                    i[r].inviewport = !1, C != t && C.enable && i.scrollTicker && i.scrollTicker(r), i[r].slides.each(function(t) {
                        ...
                        }))), i.manageNavigation && i[r].navigation.use && i.manageNavigation(r), i[r].slideamount > 1 && (!C.enable || C.enable && i[r].inviewport ? P(r) : i[r].waitForCountDown = !0), setTimeout(function() {
                        ...
                        if (c.eow <= 0 && void 0 !== c.lastknownwidth && (c.eow = c.lastknownwidth), c.eoh <= 0 && void 0 !== c.lastknownheight && (c.eoh = c.lastknownheight), void 0 !== c.corners && ("text" === c.type || "button" === c.type || "shape" === c.type)) {
                            for (r in c.corners)
                                if (c.corners.hasOwnProperty(r)) {
                                    ...
                                    c.corners[r].css("border" + (G ? "Right" : "Left"), "0px solid transparent"), c.corners[r].css("border" + ("rs-fcrt" == r || "rs-bcr" == r ? "Bottom" : "Top") + "Color", c.bgcol)
                                }
                        ...
                        if ("frame_0" !== L && "frame_hover" !== L && "loop" !== L) {
                            ...
                            if ("frame_999" !== L || !1 !== _ || "continue" !== e.mode && "start" !== e.mode && "rebuild" !== e.mode) {
                                ...
                                var A = u.frames[L],
                                    ...
                                    O = u.c,
                                    P = void 0 !== A.sfx && m(A.sfx.effect, u.m, A.timeline.ease),
                                    ...
                                    for (var B in t)
                                        if (void 0 !== A[t[B]] && !u.quickRendering) {
                                            var W = u.splitText[t[B]],
                                                ...
                                                E = u.frames[L].dosplit ? void 0 === A[t[B]].delay ? .05 : A[t[B]].delay / 100 : 0;
                                            u.color[g] === M.color && "frame_1" === L || (F.color = M.color), void 0 !== H && u.color[g] !== H.color && (Y.color = H.color), void 0 !== Y && Y.color !== M.color && (F.color = M.color);
                                            var V = jQuery.extend(!0, {}, F),
                                                X = u.fff ? jQuery.extend(!0, {}, Y) : void 0,
                                                Z = A[t[B]].dir;
                                            delete V.dir, V.data = {
                                                splitted: !0
                                            }, V.stagger = "center" === Z || "edge" === Z ? s({
                                                each: E,
                                                offset: E / 2,
                                                from: Z
                                            }) : {
                                                each: E,
                                                from: Z
                                            }, V.duration = G, void 0 !== X && delete X.dir, u.fff ? z.add(C.fromTo(W, X, V), 0) : z.add(C.to(W, V), 0), j = Math.max(j, W.length * E)
                                        }
                                G += j, u.pxundermask || void 0 !== N && (void 0 !== I && "hidden" === I.mask.overflow || "hidden" === A.mask.overflow) ? (z.add(tpGS.gsap.to(u.m, .001, {
                                    overflow: "hidden"
                                }), 0), "column" === u.type && z.add(tpGS.gsap.to(u.cbgmask, .001, {
                                    overflow: "hidden"
                                }), 0), u.btrans && (D && (D.rotationX = u.btrans.rX, D.rotationY = u.btrans.rY, D.rotationZ = u.btrans.rZ, D.opacity = u.btrans.o), N.rotationX = u.btrans.rX, N.rotationY = u.btrans.rY, N.rotationZ = u.btrans.rZ, N.opacity = u.btrans.o), u.fff ? z.add(tpGS.gsap.fromTo([u.m, u.cbgmask], G, jQuery.extend(!0, {}, D), jQuery.extend(!0, {}, N)), .001) : z.add(tpGS.gsap.to([u.m, u.cbgmask], G, jQuery.extend(!0, {}, N)), .001)) : void 0 !== u.btrans ? z.add(tpGS.gsap.to(u.m, .001, {
                                    x: 0,
                                    y: 0,
                                    filter: "none",
                                    opacity: u.btrans.o,
                ...
                if (R || (u.lastRequestedMainFrame = "start" === e.mode ? "frame_1" : "continue" === e.mode ? void 0 === e.frame ? u.currentframe : e.frame : u.lastRequestedMainFrame), void 0 !== e.totime ? u.tSTART = e.totime : void 0 !== f && void 0 === e.frame ? u.tSTART = f : void 0 !== e.frame ? u.tSTART = e.frame : u.tSTART = 0, 0 === u.tSTART && void 0 === u.startedAnimOnce && void 0 === u.leftstage && void 0 === u.startedAnimOnce && !0 === u.hideonfirststart && "preset" === e.mode && (i[p]._L[a[0].id].p[0].classList.add("rs-forcehidden"), u.hideonfirststart = !1), "frame_999" !== u.tSTART && "frame_999" !== u.triggeredFrame || !u.leftstage && void 0 !== u.startedAnimOnce) {
                    if ("true" != u.animationonscroll && 1 != u.animationonscroll ? u.timeline.play(u.tSTART) : u.timeline.time(u.tSTART), jQuery.inArray(u.type, ["group", "row", "column"]) >= 0 && void 0 !== e.frame) {
                        if (void 0 === u.childrenJS)
                            for (var B in u.childrenJS = {}, i[p]._L) void 0 !== i[p]._L[B]._lig && void 0 !== i[p]._L[B]._lig[0] && i[p]._L[B]._lig[0].id === a[0].id && i[p]._L[B]._lig[0].id !== i[p]._L[B].c[0].id && (u.childrenJS[i[p]._L[B].c[0].id] = i[p]._L[B].c);
                        ...
                        if (!0 === e.updateChildren)
                            for (var B in u.childrenJS) u.childrenJS.hasOwnProperty(B) && i.renderLayerAnimation({
                            ...
                            for (var B in u.childrenJS) u.childrenJS.hasOwnProperty(B) && i[p]._L[B].pausedTrueParrent && (i.renderLayerAnimation({
                                layer: u.childrenJS[B],
                                fastforward: !1,
                                id: p,
                                mode: "continue",
        ...
        y = function(e) {
            ...
            for (var l in r)
                if (r.hasOwnProperty(l)) {
                    ...
                    "skewX" === l && void 0 !== r[l] && 0 !== parseFloat(r[l]) && (r.scaleY = void 0 === r.scaleY ? 1 : parseFloat(r.scaleY), r.scaleY *= Math.cos(parseFloat(r[l]) * tpGS.DEG2RAD)), "skewY" === l && void 0 !== r[l] & 0 !== parseFloat(r[l]) && (r.scaleX = void 0 === r.scaleX ? 1 : parseFloat(r.scaleX), r.scaleX *= Math.cos(parseFloat(r[l]) * tpGS.DEG2RAD))
                }
        ...
        R = function(e, t, a, r, o) {
            ...
            if ("column" === s.type && tpGS.gsap.set(s._column, {
                ...
                if ("IFRAME" == e[0].nodeName && "html" === i.gA(e[0], "layertype") && (c = "slide" == g.basealign ? i[t].ulw : i.iWA(t, o), p = "slide" == g.basealign ? i[t].ulh : i.iHE(t), v.width = !jQuery.isNumeric(g.width) && g.width.indexOf("%") >= 0 ? !s._isstatic || s._incolumn || s._ingroup ? g.width : c * parseInt(g.width, 0) / 100 : L(g.width, u, "auto", c, "auto"), v.height = !jQuery.isNumeric(g.height) && g.height.indexOf("%") >= 0 ? !s._isstatic || s._incolumn || s._ingroup ? g.height : p * parseInt(g.height, 0) / 100 : L(g.height, f, "auto", c, "auto")), tpGS.gsap.set(e, v), "rekursive" != a) {
                    ...
                    "image" === s.type && (!jQuery.isNumeric(_.width) && _.width.indexOf("%") >= 0 && (_.width = "100%"), !jQuery.isNumeric(_.height) && _.height.indexOf("%") >= 0 && (_.height = "100%")), s._isgroup && (!jQuery.isNumeric(_.width) && _.width.indexOf("%") >= 0 && (_.width = "100%"), tpGS.gsap.set(s.p, {
                        height: _.height
        ...
        d = function(e) {
            ...
            jQuery(".bullet, .bullets, .tp-bullets, .tparrows").addClass("noSwipe"), t[e].navigation.touch = void 0 === t[e].navigation.touch ? {} : t[e].navigation.touch, t[e].navigation.touch.swipe_direction = void 0 === t[e].navigation.touch.swipe_direction ? "horizontal" : t[e].navigation.touch.swipe_direction, jQuery(".rs-nav-element").rsswipe({
                ...
                swipeStatus: function(i, o, s, n, d, c, p) {
                    ...
                    var u = l("RS-THUMB", i),
                        h = (l("RS-TAB", i), "start" === o ? 0 : r ? p[0].end.x - p[0].start.x : i.pageX - a.screenX),
                        ...
                        R = "vertical" === S ? x.find(_).first().outerHeight(!0) + w.space : x.find(_).first().outerWidth(!0) + w.space,
                        A = void 0 === k.data("offset") ? 0 : parseInt(k.data("offset"), 0),
                        I = 0;
                    switch (o) {
                        case "start":
                            "vertical" === S && i.preventDefault(), a.screenX = r ? p[0].end.x : i.pageX, a.screenY = r ? p[0].end.y : i.pageY, t[e].cpar.find(v).addClass("dragged"), A = "vertical" === S ? k.position().top : k.position().left, k.data("offset", A), k.data("tmmove") && k.data("tmmove").pause(), t[e].someNavIsDragged = !0, f(e);
                            break;
                        case "move":
                            if (T <= L) return !1;
                            I = (I = A + ("vertical" === S ? m : h)) > 0 ? "horizontal" === S ? I - k.width() * (I / k.width() * I / k.width()) : I - k.height() * (I / k.height() * I / k.height()) : I;
                            var z = "vertical" === S ? 0 - (k.height() - x.height()) : 0 - (k.width() - x.width());
                            I = I < z ? "horizontal" === S ? I + k.width() * (I - z) / k.width() * (I - z) / k.width() : I + k.height() * (I - z) / k.height() * (I - z) / k.height() : I, "vertical" === S ? tpGS.gsap.set(k, {
                                top: I + "px"
                            }) : tpGS.gsap.set(k, {
                                left: I + "px"
                        ...
                        case "end":
                        case "cancel":
                            return I = A + ("vertical" === S ? m : h), I = (I = "vertical" === S ? I < 0 - (k.height() - x.height()) ? 0 - (k.height() - x.height()) : I : I < 0 - (k.width() - x.width()) ? 0 - (k.width() - x.width()) : I) > 0 ? 0 : I, I = Math.abs(n) > R / 10 ? n <= 0 ? Math.floor(I / R) * R : Math.ceil(I / R) * R : n < 0 ? Math.ceil(I / R) * R : Math.floor(I / R) * R, I = (I = "vertical" === S ? I < 0 - (k.height() - x.height()) ? 0 - (k.height() - x.height()) : I : I < 0 - (k.width() - x.width()) ? 0 - (k.width() - x.width()) : I) > 0 ? 0 : I, "vertical" === S ? tpGS.gsap.to(k, .5, {
                                top: I + "px",
                                ease: "power3.out"
                            }) : tpGS.gsap.to(k, .5, {
                                left: I + "px",
                                ease: "power3.out"
                            }), I = I || ("vertical" === S ? k.position().top : k.position().left), k.data("offset", I), k.data("distance", n), t[e].cpar.find(v).removeClass("dragged"), t[e].someNavIsDragged = !1, !0
                    }
                }
        ...
        a = function(e) {
            ...
            if (0 == d) {
                ...
                switch (l.trC) {
                    ...
                    case 11:
                    case 12:
                        var P = "blur(" + (jQuery.inArray(l.trC, [9, 10]) >= 0 ? 5 : jQuery.inArray(l.trC, [11, 12]) >= 0 ? 10 : 0) + "px) grayscale(" + (jQuery.inArray(l.trC, [5, 6, 7, 8]) >= 0 ? 100 : 0) + "%) brightness(" + (jQuery.inArray(l.trC, [7, 8]) >= 0 ? 300 : 0) + "%)",
                ...
                var j = 3 == l.trC ? p / 1300 : p / 1e3,
                    ...
                    W = 4 == l.trC || 5 == l.trC ? .6 : 6 == l.trC ? 1.4 : 1,
                    F = 5 == l.trC ? 1.4 : 6 == l.trC ? .6 : 1;
                if (7 != l.trC && 4 != l.trC || (H = 0, N = 0), 8 == l.trC ? (t[a].mtl.add(tpGS.gsap.set(t[a].pr_active_slide, {
                        zIndex: 20
                ...
                Y = 1 === n ? "20% " : "80% ";
                Y += "60% -50%", void 0 !== t[a].pr_next_bg && t[a].pr_next_bg.length > 0 && t[a].mtl.add(tpGS.gsap.fromTo(t[a].pr_next_bg, p / 1e3, {
                    ...
                    delay: 0,
                    ease: m
                }), 0), Y = 1 != n ? "20% " : "80% ", Y += "60% -50%", t[a].mtl.add(tpGS.gsap.fromTo(t[a].pr_active_bg, p / 1e3, {
                    autoAlpha: 1,
                    rotationX: 0,
                    top: 0,
                    z: 0,
                ...
                void 0 !== t[a].pr_next_bg && t[a].pr_next_bg.length > 0 && t[a].mtl.add(tpGS.gsap.fromTo(t[a].pr_next_bg, p / 1e3, {
                    ...
                    rotationY: 0,
                    ease: m
                }), 0), Y = 1 === n ? 25 === d ? "center bottom 0" : "right center 0" : 25 === d ? "center top 0" : "left center 0", E = 25 !== d ? -E : E, V = 25 !== d ? V : -V, t[a].mtl.add(tpGS.gsap.fromTo(t[a].pr_active_bg, p / 1e3, {
                    rotationX: 0,
                    rotationY: 0,
                    transformStyle: "flat",
                    transformPerspective: 1200,
                ...
                $[ne] = "0%", ee[ne] = Z, te[ne] = K, ie[ne] = 0, ae[ne] = q, re[ne] = Z, oe[ne] = U, se[ne] = J, X.append('<span style="background-color:rgba(0,0,0,0.6);width:100%;height:100%;position:absolute;top:0px;left:0px;display:block;z-index:2"></span>'), void 0 !== t[a].pr_active_bg && t[a].pr_active_bg.length > 0 && t[a].mtl.add(tpGS.gsap.fromTo(t[a].pr_active_bg, p / 1e3, $, ee), 0), void 0 !== t[a].pr_next_bg && t[a].pr_next_bg.length > 0 && t[a].mtl.add(tpGS.gsap.fromTo(t[a].pr_next_bg.find("rs-sbg"), p / 2e3, te, ie), p / 2e3), t[a].mtl.add(tpGS.gsap.fromTo(X, p / 1e3, ae, re), 0), t[a].mtl.add(tpGS.gsap.fromTo(X.find(".slotslide div"), p / 1e3, oe, se), 0)
            }
        },
